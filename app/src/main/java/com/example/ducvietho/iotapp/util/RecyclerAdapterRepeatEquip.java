...
public class RecyclerAdapterRepeatEquip extends RecyclerView.Adapter<RecyclerAdapterRepeatEquip.ViewHolder> {
    private List<DayRepeat> mList;
    private SaveDayRepeat<Equipment> mDayRepeat;
    private Equipment object;

    public RecyclerAdapterRepeatEquip(List<DayRepeat> list, SaveDayRepeat<Equipment> dayRepeat, Equipment object) {
        mList = list;
